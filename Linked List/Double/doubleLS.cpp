...
using namespace std;
    ...
    //public:
        ...
        void doubleLS:: insertData(int newData)
        {
            Node* p = new Node;
            p->data = newData;
            p->prev = NULL;
        ...
        void doubleLS::tailDisp()
        {
            cout<<"Tail is "<< tail->data<<endl;
        }

        void doubleLS::headDisp()
        {
            cout<<"Head is "<<head->data<<endl;
        }

        void doubleLS::insertAfter(int after, int newData)
        {
            Node* p = new Node;
            p->prev = NULL;
            p->data = newData;
        ...
        void doubleLS:: insertEnd(int newData)
        {
            Node* p = new Node;
            p->prev = NULL;
            p->data = newData;
        ...
        void doubleLS::deleteNode( int delData)
        {
            Node* temp;
    ...
    void doubleLS::reverse()
    {
        ...
        /*void DoubleLinkedList:: displayend()
        {
            Node* temp;
            temp =tail;
            while(temp!=NULL)
